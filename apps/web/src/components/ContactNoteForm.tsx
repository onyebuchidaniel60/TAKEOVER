...
export default function ContactNoteForm({
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4">
      <label htmlFor={`contact-note-${slot.id}`} className="block text-sm font-medium text-slate-900">
        Buyer contact note
      </label>
      ...
      {saved && (
        <p className="mt-1 text-sm font-medium text-slate-900" aria-live="polite">
          Saved.
        </p>
      )}
