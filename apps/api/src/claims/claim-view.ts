// Buyer-facing claim projection (snake_case). A buyer only ever sees
// their own claims, so buyer_id is safe here. No payment fields here.
...
export interface ClaimView {
  ...
  claimed_at: string;
  updated_at: string;
  // One-way provider contact note. Buyer surfaces pass the
...
// Buyer visibility gate for the provider contact note. The note
